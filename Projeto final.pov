...
light_source {<20, 150, 100> color rgb <1, 1, .7>}                
...
//////////////////////////////////////////Porta//////////////////////////////////////////////////////////////////////////////////////    
    ...
    union{
        ...
        union{
            ...
            //rotate z*-20 //maçaneta ja virada
            //rotate z*-20*clock //rotate para virar a maçaneta pra baixo 
            //rotate z*20*clock //rotate para virar a maçaneta pra cima
            translate<-32, 40, 0>}
        //placa de apresentação
        union{
            difference{
                box{<-27, 73, -3>, <-7, 58, -3.5>}
                box{<-25, 71, -4>, <-9, 60, -3.01>}
                texture{ pigment {color rgb <.15, .05, 0>}    
                normal { wood .5 scale .55 turbulence 0.1 rotate<0,0,0>}
            ...
            translate <1.7, -13, 0>}
        //fim da placa
        //rotate y*92*clock //rotate par abrir a porta
        rotate y*92 //rotate porta aberta
      ...
      cylinder {<8, 1, -19.8>, <8, 1, -20.02> 0.6 pigment {color rgb <1, 1, .7>}}
       ...
       #declare screen = union{
                        ...
                        #declare cursor = union{
                            difference{
                                union{
                                    cone {<.5, -.5, 0> .5, <-.5, .5, 0> 0}
                                    cylinder {<.5, -.5, 0>, <.8, -.8, 0> .2}}
                                box {<-2, -2, -2>, <2, 2, -.005>}}
                            difference {   
                                union{
                                    cone {<.5, -.5, -.05> .5, <-.5, .5, -.05> 0 pigment {color White} scale <.6, .6, 1>} 
                                    cylinder {<.3, -.3, 0>, <.7, -.7, 0> .1} }
                        ...
                        #declare cursorSel = union{
                            difference{
                            union{
                            cylinder {<-.8, 1.2, 0>,<-.8, -1.2, 0> .2}
                            cylinder {<-.4, .7, 0>,<-.4, -1.2, 0> .2}
                            cylinder {<0, .7, 0>,<0, -1.2, 0> .2}
                            cylinder {<.4, .3, 0>,<.4, -1.2, 0> .2}
                            cylinder {<-1.5, .4, 0>,<-.6, -1, 0> .2}}
                            box {<-2, -2, -2>, <2, 2, -.009>}}
                            
                            difference{
                                union{
                                    cylinder {<-.8, 1, 0>,<-.8, -1, 0> .15}
                                    cylinder {<-.4, .5, 0>,<-.4, -1, 0> .15}
                                    cylinder {<0, .5, 0>,<0, -1, 0> .15}
                                    cylinder {<.4, .1, 0>,<.4, -1, 0> .15}
                                    cylinder {<.2, .1, 0>,<.2, -1, 0> .15}
                                    cylinder {<-1.3, .18, 0>,<-.6, -.9, 0> .15}
                                    cylinder {<-.4, .5, 0>,<-.4, -1, 0> .5}}
                                box {<-2, -2, -2>, <2, 2, -.01>}
                                pigment {color White}}
                            scale <.6, .6, .4>
                            translate <-14.4, 15, 0>}
...
translate <5,0,2>} //Fim do union estante / pc 
 ...
 object {pe}
 object {pe rotate y*72}
 object {pe rotate y*144}
 object {pe rotate y*216}
 object {pe rotate y*288}
 
 cylinder {<0, 4, 0>, <0, 9, 0> 1.2 pigment {color rgb <.04, .04, .04>}}
 cylinder {<0, 12, 0>, <0, 8, 0> 1 pigment {color rgb <.04, .04, .04>}} 
 cylinder {<0, 10, 0>, <0, 17, 0> .7 pigment {color rgb <.4, .4, .4>} finish {Metal}}
 #declare assento = union{
     difference {
        object{Round_Box(<-8,18,-8>,<8,17,8>, 2.25   , 0) }
        box {<-10, 17.4, -10>, <10, 20, 10>} pigment {color rgb <.04, .04, .04>}}
     difference {
        object{Round_Box(<-7.8,18,-7.8>,<7.8,17,7.8>, 2.25   , 0) texture{ pigment {color rgb <.44, .04, .04>}
                    normal { pigment_pattern{
                                average pigment_map{[1, gradient z sine_wave]
                                                    [1, gradient y scallop_wave]
                                                    [3, bumps  ]}
                                             translate 0.02 scale 0.8}
                                             2 
                             rotate< 0,0,0> scale 0.15 } // end normal
                    finish { phong 0.08}}}
        box {<-10, 17, -10>, <10, 10, 10>} }}
 ...
 object {assento 
    ...
    rotate z*-87
    translate <0, 30, 0>}
 object { Round_Cylinder(<-8,15,0>, <-8.5,23,0>, 0.50 ,       0.20,   0) pigment {color rgb <.04, .04, .04>}}
 object { Round_Cylinder(<-8.5,15,0>, <-6,15,0>, 0.50 ,       0.20,   0) pigment {color rgb <.04, .04, .04>}}
 
 object { Round_Cylinder(<0,15.5,-5>, <0,15,-9>, 0.50 ,       0.20,   0) pigment {color rgb <.04, .04, .04>}}
 object { Round_Cylinder(<0,14.5,-9>, <0,24,-9>, 0.50 ,       0.20,   0) pigment {color rgb <.04, .04, .04>}}
